...
import heroImg from '../images/hero-laundary.svg';
                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            {/* We build digital solutions to help businesses scale */}
                                Your Fresh Start: Premium Laundry Services at Your Doorstep!
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">Convenient, eco-friendly laundry services tailored to your needs.</div>
